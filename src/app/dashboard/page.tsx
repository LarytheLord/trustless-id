  ...
  useEffect(() => {
    if (user) {
      ...
      setStats({
        ...
        verifiedDocuments: userDocs.filter((d) => d.status === "verified")
          .length,
        activeCredentials: userCreds.filter((c) => c.status === "active")
          .length,
        recentVerifications: userCreds.reduce(
          (acc, c) => acc + c.verificationCount,
          0,
        ),
      });
    }
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <Card className="glass border-white/5 mt-6">
            <CardHeader>
              ...
              <CardDescription>
                Your blockchain-backed identity credentials
              </CardDescription>
            </CardHeader>
            <CardContent>
