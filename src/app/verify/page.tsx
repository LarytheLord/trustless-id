  ...
  const handleVerify = async () => {
    ...
    try {
      const response = await fetch(
        `/api/verify?id=${encodeURIComponent(credentialId.trim())}`,
      );
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              Enter a credential ID to verify its authenticity without exposing
              personal data
            </p>
          </div>
          ...
          {result && (
            <Card
              className={`border-2 ${result.isValid ? "border-green-500/30 bg-green-500/5" : "border-red-500/30 bg-red-500/5"}`}
            >
                    ...
                    <div className="mt-6 p-4 rounded-lg bg-primary/5 border border-primary/10">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">
                            No personal information was exposed during this
                            verification. Only the credential validity and trust
                            score are shown.
                          </p>
                        </div>
                      </div>
          ...
          <Card className="glass border-white/5 mt-6">
            <CardHeader>
              ...
              <CardDescription>
                Scan a credential QR code for instant verification
              </CardDescription>
            </CardHeader>
            <CardContent>
