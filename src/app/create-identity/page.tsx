        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              Complete the steps below to create your decentralized identity
              credential
            </p>
          </div>
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {(
                        ["passport", "drivers_license", "national_id"] as const
                      ).map((type) => (
                        <button
                          key={type}
                          onClick={() =>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Demo mode: file upload is simulated. No actual files are
                      stored.
                    </p>
                  </div>
                </div>
                  ...
                  {isProcessing ? (
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Authenticity score: {verificationResult.authenticity}%
                        </p>
                      </div>
                      <div className="grid grid-cols-2 gap-4 text-left">
                        ...
                        <div className="p-3 rounded-lg bg-background/50">
                          ...
                          <p className="font-medium">
                            {verificationResult.anomalies.length} detected
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  {isProcessing ? (
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Your credential has been issued and recorded on the
                          blockchain.
                        </p>
                      </div>
